...
Unfortunately, the interface is currently not online. However, a new version of a very similar project by the same authors has come to live, [check here](/apps/freesound-explorer.html).